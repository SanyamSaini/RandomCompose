...
fun YouTubeUI(youtubeData: YoutubeData) {
    ...
    Card(modifier = Modifier
        ...
        Column(modifier = Modifier.background(GreenJC)) {
            Image(painter = painterResource(id = youtubeData.thumbnail), contentDescription = null,
            ...
            Column(modifier = Modifier.fillMaxWidth()
                ...
                Text(text = youtubeData.channelName, maxLines = 1, color = Color.White, fontSize = 14.sp)
            }
        }
    }
}